    ...
    def test_required_fields(self):
        ...
        for i in range(len(json_response)):
            for j in range(len(required_fields)):
                self.assertTrue(required_fields[j] in json_response[i])
...
################################################################################
    ...
    def test_escalators(self):
        ...
        for i in range(len(json_response)):
            self.assertEqual(json_response[i]['UnitType'], 'ESCALATOR')
    ...
    def test_elevators(self):
        ...
        for i in range(len(json_response)):
            self.assertEqual(json_response[i]['UnitType'], 'ELEVATOR')
